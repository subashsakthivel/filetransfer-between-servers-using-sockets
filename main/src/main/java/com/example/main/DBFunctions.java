...
public class DBFunctions {
    ...
    public void insert_row(Connection conn, String table_name,String filename, String fileLocation, String creation_time, String request) {
        Statement statement;
        try {
            String query = String.format("insert into %s(name,location,creation_time,request) values('%s','%s','%s','%s');",table_name,filename,fileLocation,creation_time, request);
            statement = conn.createStatement();
            statement.executeUpdate(query);
